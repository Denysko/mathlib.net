...
namespace mathlib.special
{
	...
	public class Erf
	{
		...
		/// <summary>
		/// The number {@code X_CRIT} is used by <seealso cref="#erf(double, double)"/> internally.
		/// This number solves {@code erf(x)=0.5} within 1ulp.
		/// More precisely, the current implementations of
		/// <seealso cref="#erf(double)"/> and <seealso cref="#erfc(double)"/> satisfy:<br/>
		...
		/// <seealso cref="Gamma#regularizedGammaP(double, double, double, int) regularized gamma function"/>,
...
//ORIGINAL LINE: final double ret = Gamma.regularizedGammaP(0.5, x * x, 1.0e-15, 10000);
		...
		/// <br/>
		///    = 1 - <seealso cref="#erf(double) erf(x)"/> </p>
		/// 
		/// <p>This implementation computes erfc(x) using the
		/// <seealso cref="Gamma#regularizedGammaQ(double, double, double, int) regularized gamma function"/>,
		/// following <a href="http://mathworld.wolfram.com/Erf.html"> Erf</a>, equation (3).</p>
		/// 
...
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final double ret = Gamma.regularizedGammaQ(0.5, x * x, 1.0e-15, 10000);
...
//ORIGINAL LINE: public static double erfInv(final double x)
		...
		/// <summary>
		/// Returns the inverse erfc. </summary>
		/// <param name="x"> the value </param>
		/// <returns> t such that x = erfc(t)
		/// @since 3.2 </returns>
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static double erfcInv(final double x)
