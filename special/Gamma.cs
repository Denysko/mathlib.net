...
namespace mathlib.special
{
    ...
    public class Gamma
    {
        ...
        private static readonly double INV_GAMMA1P_M1_A0 = 6.11609510448141581788E-9;

        /// <summary>
        /// The constant {@code A1} defined in {@code DGAM1}. </summary>
        private static readonly double INV_GAMMA1P_M1_A1 = 6.24730830116465516210E-9;

        /// <summary>
        /// The constant {@code B1} defined in {@code DGAM1}. </summary>
        private static readonly double INV_GAMMA1P_M1_B1 = 0.203610414066806987300;

        /// <summary>
        /// The constant {@code B2} defined in {@code DGAM1}. </summary>
        private static readonly double INV_GAMMA1P_M1_B2 = 2.66205348428949217746E-2;

        /// <summary>
        /// The constant {@code B3} defined in {@code DGAM1}. </summary>
        private static readonly double INV_GAMMA1P_M1_B3 = 4.93944979382446875238E-4;

        /// <summary>
        /// The constant {@code B4} defined in {@code DGAM1}. </summary>
        private static readonly double INV_GAMMA1P_M1_B4 = -8.51419432440314906588E-6;

        /// <summary>
        /// The constant {@code B5} defined in {@code DGAM1}. </summary>
        private static readonly double INV_GAMMA1P_M1_B5 = -6.43045481779353022248E-6;

        /// <summary>
        /// The constant {@code B6} defined in {@code DGAM1}. </summary>
        private static readonly double INV_GAMMA1P_M1_B6 = 9.92641840672773722196E-7;

        /// <summary>
        /// The constant {@code B7} defined in {@code DGAM1}. </summary>
        private static readonly double INV_GAMMA1P_M1_B7 = -6.07761895722825260739E-8;

        /// <summary>
        /// The constant {@code B8} defined in {@code DGAM1}. </summary>
        private static readonly double INV_GAMMA1P_M1_B8 = 1.95755836614639731882E-10;

        /// <summary>
        /// The constant {@code P0} defined in {@code DGAM1}. </summary>
        private static readonly double INV_GAMMA1P_M1_P0 = 6.116095104481415817861E-9;

        /// <summary>
        /// The constant {@code P1} defined in {@code DGAM1}. </summary>
        private static readonly double INV_GAMMA1P_M1_P1 = 6.871674113067198736152E-9;

        /// <summary>
        /// The constant {@code P2} defined in {@code DGAM1}. </summary>
        private static readonly double INV_GAMMA1P_M1_P2 = 6.820161668496170657918E-10;

        /// <summary>
        /// The constant {@code P3} defined in {@code DGAM1}. </summary>
        private const double INV_GAMMA1P_M1_P3 = 4.686843322948848031080E-11;
        ...
        private static readonly double INV_GAMMA1P_M1_Q1 = 0.3056961078365221025009;

        /// <summary>
        /// The constant {@code Q2} defined in {@code DGAM1}. </summary>
        private static readonly double INV_GAMMA1P_M1_Q2 = 5.464213086042296536016E-2;

        /// <summary>
        /// The constant {@code Q3} defined in {@code DGAM1}. </summary>
        private static readonly double INV_GAMMA1P_M1_Q3 = 4.956830093825887312020E-3;

        /// <summary>
        /// The constant {@code Q4} defined in {@code DGAM1}. </summary>
        private static readonly double INV_GAMMA1P_M1_Q4 = 2.692369466186361192876E-4;

        /// <summary>
        /// The constant {@code C} defined in {@code DGAM1}. </summary>
        private static readonly double INV_GAMMA1P_M1_C = -0.422784335098467139393487909917598;

        /// <summary>
        /// The constant {@code C0} defined in {@code DGAM1}. </summary>
        private static readonly double INV_GAMMA1P_M1_C0 = 0.577215664901532860606512090082402;

        /// <summary>
        /// The constant {@code C1} defined in {@code DGAM1}. </summary>
        private static readonly double INV_GAMMA1P_M1_C1 = -0.655878071520253881077019515145390;

        /// <summary>
        /// The constant {@code C2} defined in {@code DGAM1}. </summary>
        private static readonly double INV_GAMMA1P_M1_C2 = -4.20026350340952355290039348754298E-2;

        /// <summary>
        /// The constant {@code C3} defined in {@code DGAM1}. </summary>
        private static readonly double INV_GAMMA1P_M1_C3 = 0.166538611382291489501700795102105;

        /// <summary>
        /// The constant {@code C4} defined in {@code DGAM1}. </summary>
        private static readonly double INV_GAMMA1P_M1_C4 = -4.21977345555443367482083012891874E-2;

        /// <summary>
        /// The constant {@code C5} defined in {@code DGAM1}. </summary>
        private static readonly double INV_GAMMA1P_M1_C5 = -9.62197152787697356211492167234820E-3;

        /// <summary>
        /// The constant {@code C6} defined in {@code DGAM1}. </summary>
        private static readonly double INV_GAMMA1P_M1_C6 = 7.21894324666309954239501034044657E-3;

        /// <summary>
        /// The constant {@code C7} defined in {@code DGAM1}. </summary>
        private static readonly double INV_GAMMA1P_M1_C7 = -1.16516759185906511211397108401839E-3;

        /// <summary>
        /// The constant {@code C8} defined in {@code DGAM1}. </summary>
        private static readonly double INV_GAMMA1P_M1_C8 = -2.15241674114950972815729963053648E-4;

        /// <summary>
        /// The constant {@code C9} defined in {@code DGAM1}. </summary>
        private static readonly double INV_GAMMA1P_M1_C9 = 1.28050282388116186153198626328164E-4;

        /// <summary>
        /// The constant {@code C10} defined in {@code DGAM1}. </summary>
        private static readonly double INV_GAMMA1P_M1_C10 = -2.01348547807882386556893914210218E-5;

        /// <summary>
        /// The constant {@code C11} defined in {@code DGAM1}. </summary>
        private static readonly double INV_GAMMA1P_M1_C11 = -1.25049348214267065734535947383309E-6;

        /// <summary>
        /// The constant {@code C12} defined in {@code DGAM1}. </summary>
        private static readonly double INV_GAMMA1P_M1_C12 = 1.13302723198169588237412962033074E-6;

        /// <summary>
        /// The constant {@code C13} defined in {@code DGAM1}. </summary>
        private static readonly double INV_GAMMA1P_M1_C13 = -2.05633841697760710345015413002057E-7;
