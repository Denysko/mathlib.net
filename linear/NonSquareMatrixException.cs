...
namespace mathlib.linear
{
	...
	public class NonSquareMatrixException : DimensionMismatchException
	{
		...
		private const long serialVersionUID = -660069396594485772L;
		...
		public NonSquareMatrixException(int wrong, int expected) : base(LocalizedFormats.NON_SQUARE_MATRIX, wrong, expected)
		{
		}
	}
