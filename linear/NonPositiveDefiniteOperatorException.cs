...
namespace mathlib.linear
{
	...
	/// <seealso cref="RealLinearOperator"/> is expected.
	...
	/// @since 3.0
	/// </summary>
	public class NonPositiveDefiniteOperatorException : MathIllegalArgumentException
	{
		/// <summary>
		/// Serializable version Id. </summary>
		private const long serialVersionUID = 917034489420549847L;

		/// <summary>
		/// Creates a new instance of this class. </summary>
		public NonPositiveDefiniteOperatorException() : base(LocalizedFormats.NON_POSITIVE_DEFINITE_OPERATOR)
		{
		}
	}
