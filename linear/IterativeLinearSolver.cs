...
//ORIGINAL LINE: public IterativeLinearSolver(final mathlib.util.IterationManager manager) throws mathlib.exception.NullArgumentException
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
...
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in .NET:
//ORIGINAL LINE: protected static void checkParameters(final RealLinearOperator a, final RealVector b, final RealVector x0) throws mathlib.exception.NullArgumentException, NonSquareOperatorException, mathlib.exception.DimensionMismatchException
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
...
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in .NET:
//ORIGINAL LINE: public RealVector solve(final RealLinearOperator a, final RealVector b) throws mathlib.exception.NullArgumentException, NonSquareOperatorException, mathlib.exception.DimensionMismatchException, mathlib.exception.MaxCountExceededException
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
...
//ORIGINAL LINE: final RealVector x = new ArrayRealVector(a.getColumnDimension());
		...
		/// has been set at construction of the <seealso cref="IterationManager"/> </exception>
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in .NET:
//ORIGINAL LINE: public RealVector solve(RealLinearOperator a, RealVector b, RealVector x0) throws mathlib.exception.NullArgumentException, NonSquareOperatorException, mathlib.exception.DimensionMismatchException, mathlib.exception.MaxCountExceededException
		...
		/// has been set at construction of the <seealso cref="IterationManager"/> </exception>
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in .NET:
//ORIGINAL LINE: public abstract RealVector solveInPlace(RealLinearOperator a, RealVector b, RealVector x0) throws mathlib.exception.NullArgumentException, NonSquareOperatorException, mathlib.exception.DimensionMismatchException, mathlib.exception.MaxCountExceededException;
