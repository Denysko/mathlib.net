...
namespace org.apache.commons.math3.linear
{
	...
	/// @since 2.0 </param>
	public abstract class AbstractFieldMatrix<T> : FieldMatrix<T> where T : org.apache.commons.math3.FieldElement<T>
	{
		/// <summary>
...
//ORIGINAL LINE: protected AbstractFieldMatrix(final org.apache.commons.math3.Field<T> field)
...
//ORIGINAL LINE: protected AbstractFieldMatrix(final org.apache.commons.math3.Field<T> field, final int rowDimension, final int columnDimension) throws org.apache.commons.math3.exception.NotStrictlyPositiveException
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
...
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in .NET:
//ORIGINAL LINE: protected static <T extends org.apache.commons.math3.FieldElement<T>> org.apache.commons.math3.Field<T> extractField(final T[][] d) throws org.apache.commons.math3.exception.NoDataException, org.apache.commons.math3.exception.NullArgumentException
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
		protected internal static Field<T> extractField<T>(T[][] d) where T : org.apache.commons.math3.FieldElement<T>
		{
			if (d == null)
			{
...
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in .NET:
//ORIGINAL LINE: protected static <T extends org.apache.commons.math3.FieldElement<T>> org.apache.commons.math3.Field<T> extractField(final T[] d) throws org.apache.commons.math3.exception.NoDataException
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
		protected internal static Field<T> extractField<T>(T[] d) where T : org.apache.commons.math3.FieldElement<T>
		{
			if (d.Length == 0)
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: @Deprecated("as of 3.2, replaced by <seealso cref="MathArrays#buildArray(org.apache.commons.math3.Field, int, int)"/>") protected static <T extends org.apache.commons.math3.FieldElement<T>> T[][] buildArray(final org.apache.commons.math3.Field<T> field, final int rows, final int columns)
		[Obsolete("as of 3.2, replaced by <seealso cref="MathArrays#buildArray(org.apache.commons.math3.Field, int, int)"/>")]
		protected internal static T[][] buildArray<T>(Field<T> field, int rows, int columns) where T : org.apache.commons.math3.FieldElement<T>
		{
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: @Deprecated("as of 3.2, replaced by <seealso cref="MathArrays#buildArray(org.apache.commons.math3.Field, int)"/>") protected static <T extends org.apache.commons.math3.FieldElement<T>> T[] buildArray(final org.apache.commons.math3.Field<T> field, final int length)
		[Obsolete("as of 3.2, replaced by <seealso cref="MathArrays#buildArray(org.apache.commons.math3.Field, int)"/>")]
		protected internal static T[] buildArray<T>(Field<T> field, int length) where T : org.apache.commons.math3.FieldElement<T>
		{
		...
		/// {@inheritDoc} </summary>
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in .NET:
//ORIGINAL LINE: public abstract FieldMatrix<T> createMatrix(final int rowDimension, final int columnDimension) throws org.apache.commons.math3.exception.NotStrictlyPositiveException;
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
...
//ORIGINAL LINE: final FieldMatrix<T> out = createMatrix(rowCount, columnCount);
		...
		/// {@inheritDoc} </summary>
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in .NET:
//ORIGINAL LINE: public FieldMatrix<T> multiply(final FieldMatrix<T> m) throws org.apache.commons.math3.exception.DimensionMismatchException
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
...
//ORIGINAL LINE: final FieldMatrix<T> out = createMatrix(nRows, nCols);
		...
		/// {@inheritDoc} </summary>
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in .NET:
//ORIGINAL LINE: public FieldMatrix<T> preMultiply(final FieldMatrix<T> m) throws org.apache.commons.math3.exception.DimensionMismatchException
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
		...
		/// {@inheritDoc} </summary>
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in .NET:
//ORIGINAL LINE: public FieldMatrix<T> power(final int p) throws NonSquareMatrixException, org.apache.commons.math3.exception.NotPositiveException
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
...
//ORIGINAL LINE: final FieldMatrix<T> r = s.multiply(s);
		...
		public virtual T[][] Data
		{
			...
			{
	//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
	//ORIGINAL LINE: final T[][] data = org.apache.commons.math3.util.MathArrays.buildArray(field, getRowDimension(), getColumnDimension());
	...
	//ORIGINAL LINE: final T[] dataI = data[i];
		...
		/// {@inheritDoc} </summary>
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in .NET:
//ORIGINAL LINE: public FieldMatrix<T> getSubMatrix(final int startRow, final int endRow, final int startColumn, final int endColumn) throws org.apache.commons.math3.exception.NumberIsTooSmallException, org.apache.commons.math3.exception.OutOfRangeException
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
...
//ORIGINAL LINE: final FieldMatrix<T> subMatrix = createMatrix(endRow - startRow + 1, endColumn - startColumn + 1);
		...
		/// {@inheritDoc} </summary>
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in .NET:
//ORIGINAL LINE: public FieldMatrix<T> getSubMatrix(final int[] selectedRows, final int[] selectedColumns) throws org.apache.commons.math3.exception.NoDataException, org.apache.commons.math3.exception.NullArgumentException, org.apache.commons.math3.exception.OutOfRangeException
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
...
//ORIGINAL LINE: @Override public T visit(final int row, final int column, final T value)
		...
		/// {@inheritDoc} </summary>
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in .NET:
//ORIGINAL LINE: public void copySubMatrix(final int startRow, final int endRow, final int startColumn, final int endColumn, final T[][] destination) throws MatrixDimensionMismatchException, org.apache.commons.math3.exception.NumberIsTooSmallException, org.apache.commons.math3.exception.OutOfRangeException
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
...
//ORIGINAL LINE: @Override public void visit(final int row, final int column, final T value)
		...
		/// {@inheritDoc} </summary>
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in .NET:
//ORIGINAL LINE: public void copySubMatrix(int[] selectedRows, int[] selectedColumns, T[][] destination) throws MatrixDimensionMismatchException, org.apache.commons.math3.exception.NoDataException, org.apache.commons.math3.exception.NullArgumentException, org.apache.commons.math3.exception.OutOfRangeException
...
//ORIGINAL LINE: final T[] destinationI = destination[i];
		...
		/// {@inheritDoc} </summary>
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in .NET:
//ORIGINAL LINE: public void setSubMatrix(final T[][] subMatrix, final int row, final int column) throws org.apache.commons.math3.exception.DimensionMismatchException, org.apache.commons.math3.exception.OutOfRangeException, org.apache.commons.math3.exception.NoDataException, org.apache.commons.math3.exception.NullArgumentException
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
...
//ORIGINAL LINE: final int nCols = subMatrix[0].length;
		...
		/// {@inheritDoc} </summary>
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in .NET:
//ORIGINAL LINE: public FieldMatrix<T> getRowMatrix(final int row) throws org.apache.commons.math3.exception.OutOfRangeException
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
...
//ORIGINAL LINE: final FieldMatrix<T> out = createMatrix(1, nCols);
		...
		/// {@inheritDoc} </summary>
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in .NET:
//ORIGINAL LINE: public void setRowMatrix(final int row, final FieldMatrix<T> matrix) throws org.apache.commons.math3.exception.OutOfRangeException, MatrixDimensionMismatchException
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
...
//ORIGINAL LINE: final int nCols = getColumnDimension();
		...
		/// {@inheritDoc} </summary>
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in .NET:
//ORIGINAL LINE: public FieldMatrix<T> getColumnMatrix(final int column) throws org.apache.commons.math3.exception.OutOfRangeException
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
...
//ORIGINAL LINE: final FieldMatrix<T> out = createMatrix(nRows, 1);
		...
		/// {@inheritDoc} </summary>
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in .NET:
//ORIGINAL LINE: public void setColumnMatrix(final int column, final FieldMatrix<T> matrix) throws org.apache.commons.math3.exception.OutOfRangeException, MatrixDimensionMismatchException
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
...
//ORIGINAL LINE: final int nRows = getRowDimension();
		...
		/// {@inheritDoc} </summary>
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in .NET:
//ORIGINAL LINE: public FieldVector<T> getRowVector(final int row) throws org.apache.commons.math3.exception.OutOfRangeException
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
		...
		/// {@inheritDoc} </summary>
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in .NET:
//ORIGINAL LINE: public void setRowVector(final int row, final FieldVector<T> vector) throws org.apache.commons.math3.exception.OutOfRangeException, MatrixDimensionMismatchException
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
...
//ORIGINAL LINE: final int nCols = getColumnDimension();
		...
		/// {@inheritDoc} </summary>
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in .NET:
//ORIGINAL LINE: public FieldVector<T> getColumnVector(final int column) throws org.apache.commons.math3.exception.OutOfRangeException
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
		...
		/// {@inheritDoc} </summary>
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in .NET:
//ORIGINAL LINE: public void setColumnVector(final int column, final FieldVector<T> vector) throws org.apache.commons.math3.exception.OutOfRangeException, MatrixDimensionMismatchException
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
...
//ORIGINAL LINE: final int nRows = getRowDimension();
		...
		/// {@inheritDoc} </summary>
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in .NET:
//ORIGINAL LINE: public T[] getRow(final int row) throws org.apache.commons.math3.exception.OutOfRangeException
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
...
//ORIGINAL LINE: final int nCols = getColumnDimension();
			int nCols = ColumnDimension;
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final T[] out = org.apache.commons.math3.util.MathArrays.buildArray(field, nCols);
		...
		/// {@inheritDoc} </summary>
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in .NET:
//ORIGINAL LINE: public void setRow(final int row, final T[] array) throws org.apache.commons.math3.exception.OutOfRangeException, MatrixDimensionMismatchException
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
...
//ORIGINAL LINE: final int nCols = getColumnDimension();
		...
		/// {@inheritDoc} </summary>
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in .NET:
//ORIGINAL LINE: public T[] getColumn(final int column) throws org.apache.commons.math3.exception.OutOfRangeException
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
...
//ORIGINAL LINE: final int nRows = getRowDimension();
			int nRows = RowDimension;
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final T[] out = org.apache.commons.math3.util.MathArrays.buildArray(field, nRows);
		...
		/// {@inheritDoc} </summary>
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in .NET:
//ORIGINAL LINE: public void setColumn(final int column, final T[] array) throws org.apache.commons.math3.exception.OutOfRangeException, MatrixDimensionMismatchException
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
...
//ORIGINAL LINE: final int nRows = getRowDimension();
		...
		/// {@inheritDoc} </summary>
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in .NET:
//ORIGINAL LINE: public abstract T getEntry(int row, int column) throws org.apache.commons.math3.exception.OutOfRangeException;
		public abstract T getEntry(int row, int column);

		/// <summary>
		/// {@inheritDoc} </summary>
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in .NET:
//ORIGINAL LINE: public abstract void setEntry(int row, int column, T value) throws org.apache.commons.math3.exception.OutOfRangeException;
		public abstract void setEntry(int row, int column, T value);

		/// <summary>
		/// {@inheritDoc} </summary>
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in .NET:
//ORIGINAL LINE: public abstract void addToEntry(int row, int column, T increment) throws org.apache.commons.math3.exception.OutOfRangeException;
		public abstract void addToEntry(int row, int column, T increment);

		/// <summary>
		/// {@inheritDoc} </summary>
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in .NET:
//ORIGINAL LINE: public abstract void multiplyEntry(int row, int column, T factor) throws org.apache.commons.math3.exception.OutOfRangeException;
...
//ORIGINAL LINE: final FieldMatrix<T> out = createMatrix(nCols, nRows);
		...
		private class DefaultFieldMatrixPreservingVisitorAnonymousInnerClassHelper2 : DefaultFieldMatrixPreservingVisitor<T>
		{
			...
			private org.apache.commons.math3.linear.FieldMatrix<T> @out;

			public DefaultFieldMatrixPreservingVisitorAnonymousInnerClassHelper2(AbstractFieldMatrix outerInstance, T getZero, org.apache.commons.math3.linear.FieldMatrix<T> @out) : base(getZero)
			{
				this.outerInstance = outerInstance;
				this.@out = @out;
			}
...
//ORIGINAL LINE: public T getTrace() throws NonSquareMatrixException
	...
	//ORIGINAL LINE: final int nCols = getColumnDimension();
		...
		/// {@inheritDoc} </summary>
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in .NET:
//ORIGINAL LINE: public T[] operate(final T[] v) throws org.apache.commons.math3.exception.DimensionMismatchException
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
...
//ORIGINAL LINE: final T[] out = org.apache.commons.math3.util.MathArrays.buildArray(field, nRows);
		...
		/// {@inheritDoc} </summary>
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in .NET:
//ORIGINAL LINE: public FieldVector<T> operate(final FieldVector<T> v) throws org.apache.commons.math3.exception.DimensionMismatchException
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
...
//ORIGINAL LINE: final T[] out = org.apache.commons.math3.util.MathArrays.buildArray(field, nRows);
		...
		/// {@inheritDoc} </summary>
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in .NET:
//ORIGINAL LINE: public T[] preMultiply(final T[] v) throws org.apache.commons.math3.exception.DimensionMismatchException
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
...
//ORIGINAL LINE: final T[] out = org.apache.commons.math3.util.MathArrays.buildArray(field, nCols);
		...
		/// {@inheritDoc} </summary>
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in .NET:
//ORIGINAL LINE: public FieldVector<T> preMultiply(final FieldVector<T> v) throws org.apache.commons.math3.exception.DimensionMismatchException
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
...
//ORIGINAL LINE: final int columns = getColumnDimension();
		...
		/// {@inheritDoc} </summary>
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in .NET:
//ORIGINAL LINE: public T walkInRowOrder(final FieldMatrixChangingVisitor<T> visitor, final int startRow, final int endRow, final int startColumn, final int endColumn) throws org.apache.commons.math3.exception.NumberIsTooSmallException, org.apache.commons.math3.exception.OutOfRangeException
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
...
//ORIGINAL LINE: final T newValue = visitor.visit(row, column, oldValue);
		...
		/// {@inheritDoc} </summary>
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in .NET:
//ORIGINAL LINE: public T walkInRowOrder(final FieldMatrixPreservingVisitor<T> visitor, final int startRow, final int endRow, final int startColumn, final int endColumn) throws org.apache.commons.math3.exception.NumberIsTooSmallException, org.apache.commons.math3.exception.OutOfRangeException
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
...
//ORIGINAL LINE: final int columns = getColumnDimension();
		...
		/// {@inheritDoc} </summary>
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in .NET:
//ORIGINAL LINE: public T walkInColumnOrder(final FieldMatrixChangingVisitor<T> visitor, final int startRow, final int endRow, final int startColumn, final int endColumn) throws org.apache.commons.math3.exception.NumberIsTooSmallException, org.apache.commons.math3.exception.OutOfRangeException
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
...
//ORIGINAL LINE: final T newValue = visitor.visit(row, column, oldValue);
		...
		/// {@inheritDoc} </summary>
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in .NET:
//ORIGINAL LINE: public T walkInColumnOrder(final FieldMatrixPreservingVisitor<T> visitor, final int startRow, final int endRow, final int startColumn, final int endColumn) throws org.apache.commons.math3.exception.NumberIsTooSmallException, org.apache.commons.math3.exception.OutOfRangeException
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
...
//ORIGINAL LINE: public T walkInOptimizedOrder(final FieldMatrixPreservingVisitor<T> visitor)
		...
		/// {@inheritDoc} </summary>
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in .NET:
//ORIGINAL LINE: public T walkInOptimizedOrder(final FieldMatrixChangingVisitor<T> visitor, final int startRow, final int endRow, final int startColumn, final int endColumn) throws org.apache.commons.math3.exception.NumberIsTooSmallException, org.apache.commons.math3.exception.OutOfRangeException
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
		...
		/// {@inheritDoc} </summary>
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in .NET:
//ORIGINAL LINE: public T walkInOptimizedOrder(final FieldMatrixPreservingVisitor<T> visitor, final int startRow, final int endRow, final int startColumn, final int endColumn) throws org.apache.commons.math3.exception.NumberIsTooSmallException, org.apache.commons.math3.exception.OutOfRangeException
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
...
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in .NET:
//ORIGINAL LINE: protected void checkRowIndex(final int row) throws org.apache.commons.math3.exception.OutOfRangeException
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
		...
		/// <exception cref="OutOfRangeException"> if {@code index} is not valid. </exception>
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in .NET:
//ORIGINAL LINE: protected void checkColumnIndex(final int column) throws org.apache.commons.math3.exception.OutOfRangeException
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
...
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in .NET:
//ORIGINAL LINE: protected void checkSubMatrixIndex(final int startRow, final int endRow, final int startColumn, final int endColumn) throws org.apache.commons.math3.exception.NumberIsTooSmallException, org.apache.commons.math3.exception.OutOfRangeException
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
...
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in .NET:
//ORIGINAL LINE: protected void checkSubMatrixIndex(final int[] selectedRows, final int[] selectedColumns) throws org.apache.commons.math3.exception.NoDataException, org.apache.commons.math3.exception.NullArgumentException, org.apache.commons.math3.exception.OutOfRangeException
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
...
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in .NET:
//ORIGINAL LINE: protected void checkMultiplicationCompatible(final FieldMatrix<T> m) throws org.apache.commons.math3.exception.DimensionMismatchException
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
