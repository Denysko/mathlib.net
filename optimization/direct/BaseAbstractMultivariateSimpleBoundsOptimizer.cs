...
namespace mathlib.optimization.direct
{
	...
	/// 
	/// @version $Id: BaseAbstractMultivariateSimpleBoundsOptimizer.java 1462503 2013-03-29 15:48:27Z luc $ </param>
		...
		/// @deprecated See <seealso cref="mathlib.optimization.SimpleValueChecker#SimpleValueChecker()"/> 
	{
		...
		protected internal BaseAbstractMultivariateSimpleBoundsOptimizer(ConvergenceChecker<PointValuePair> checker) : base(checker)
		{
		}

		/// <summary>
		/// {@inheritDoc} </summary>
		public override PointValuePair optimize(int maxEval, FUNC f, GoalType goalType, double[] startPoint)
		{
			return base.optimizeInternal(maxEval, f, goalType, new InitialGuess(startPoint));
		}

		/// <summary>
		/// {@inheritDoc} </summary>
		public virtual PointValuePair optimize(int maxEval, FUNC f, GoalType goalType, double[] startPoint, double[] lower, double[] upper)
		{
			return base.optimizeInternal(maxEval, f, goalType, new InitialGuess(startPoint), new SimpleBounds(lower, upper));
		}
	}
