...
namespace mathlib.optimization.linear
{
	...
	/// </p>
	/// @version $Id: LinearConstraint.java 1422230 2012-12-15 12:11:13Z erans $ </summary>
...
//ORIGINAL LINE: public LinearConstraint(final mathlib.linear.RealVector lhsCoefficients, final double lhsConstant, final Relationship relationship, final mathlib.linear.RealVector rhsCoefficients, final double rhsConstant)
		...
		/// <summary>
		/// Get the coefficients of the constraint (left hand side). </summary>
		...
		/// <summary>
		/// Get the relationship between left and right hand sides. </summary>
		...
		/// <summary>
		/// Get the value of the constraint (right hand side). </summary>
