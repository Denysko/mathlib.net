...
//ORIGINAL LINE: @Deprecated("As of 3.1 (to be removed in 4.0).") public class SimplePointChecker<PAIR extends mathlib.util.Pair<double[] , ? extends Object>> extends AbstractConvergenceChecker<PAIR>
