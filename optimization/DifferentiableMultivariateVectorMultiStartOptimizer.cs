...
namespace mathlib.optimization
{
	...
	/// 
	/// @version $Id: DifferentiableMultivariateVectorMultiStartOptimizer.java 1422230 2012-12-15 12:11:13Z erans $ </summary>
	/// @deprecated As of 3.1 (to be removed in 4.0).
	/// @since 2.0 
	[Obsolete("As of 3.1 (to be removed in 4.0).")]
	public class DifferentiableMultivariateVectorMultiStartOptimizer : BaseMultivariateVectorMultiStartOptimizer<DifferentiableMultivariateVectorFunction>, DifferentiableMultivariateVectorOptimizer
	{
		/// <summary>
