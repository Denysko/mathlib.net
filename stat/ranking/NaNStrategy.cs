...
namespace mathlib.stat.ranking
{
	...
	public enum NaNStrategy
	{
		...
		/// <summary>
		/// NaNs are considered minimal in the ordering </summary>
		MINIMAL,

		/// <summary>
		/// NaNs are considered maximal in the ordering </summary>
		MAXIMAL,

		/// <summary>
		/// NaNs are removed before computing ranks </summary>
		REMOVED,

		/// <summary>
		/// NaNs are left in place </summary>
		FIXED,
