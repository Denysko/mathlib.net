...
namespace mathlib.stat.ranking
{
	...
	public enum TiesStrategy
	{
		...
		/// <summary>
		/// Ties assigned sequential ranks in order of occurrence </summary>
		SEQUENTIAL,

		/// <summary>
		/// Ties get the minimum applicable rank </summary>
		MINIMUM,

		/// <summary>
		/// Ties get the maximum applicable rank </summary>
		MAXIMUM,

		/// <summary>
		/// Ties get the average of applicable ranks </summary>
		AVERAGE,

		/// <summary>
		/// Ties get a random integral value from among applicable ranks </summary>
		RANDOM
	}
