...
namespace mathlib.random
{
	...
	/// @version $Id: Well1024a.java 1416643 2012-12-03 19:37:14Z tn $
	/// @since 2.2
	///  </seealso>
	public class Well1024a : AbstractWell
	{
		...
		private const long serialVersionUID = 5680173464174485492L;
		...
		/// seed.</p>
		/// </summary>
		public Well1024a() : base(K, M1, M2, M3)
		{
		}
		...
		public Well1024a(int seed) : base(K, M1, M2, M3, seed)
		{
		}
		...
		public Well1024a(long seed) : base(K, M1, M2, M3, seed)
		{
		}
...
//ORIGINAL LINE: final int z0 = v[indexRm1];
			int z0 = v[indexRm1];
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final int z1 = v0 ^ (vM1 ^ (vM1 >>> 8));
			int z1 = v0 ^ (vM1 ^ ((int)((uint)vM1 >> 8)));
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final int z2 = (vM2 ^ (vM2 << 19)) ^ (vM3 ^ (vM3 << 14));
			int z2 = (vM2 ^ (vM2 << 19)) ^ (vM3 ^ (vM3 << 14));
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final int z3 = z1 ^ z2;
			int z3 = z1 ^ z2;
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final int z4 = (z0 ^ (z0 << 11)) ^ (z1 ^ (z1 << 7)) ^ (z2 ^ (z2 << 13));
