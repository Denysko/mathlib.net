...
//ORIGINAL LINE: public enum LocalizedFormats implements Localizable
	public enum LocalizedFormats
	{
		...
		CANNOT_COMPUTE_BETA_DENSITY_AT_0FOR_SOME_ALPHA("cannot compute beta density at 0 when alpha = {0,number}"),
		CANNOT_COMPUTE_BETA_DENSITY_AT_1FOR_SOME_BETA("cannot compute beta density at 1 when beta = %.3g"),
		...
		/// <summary>
		/// {@inheritDoc} </summary>
		public String getLocalizedString(final java.util.Locale locale)
		{
