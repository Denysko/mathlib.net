...
namespace org.apache.commons.math3.exception
{
	...
	public class MathIllegalNumberException : MathIllegalArgumentException
	{
		...
		/// <summary>
		/// Requested. </summary>
		private readonly Number argument;
		...
		protected internal MathIllegalNumberException(Localizable pattern, Number wrong, params object[] arguments) : base(pattern, wrong, arguments)
		{
			argument = wrong;
		}

		/// <returns> the requested value. </returns>
		public virtual Number Argument
		{
			get
			{
				return argument;
