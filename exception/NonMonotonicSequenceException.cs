...
namespace mathlib.exception
{
    ...
    public class NonMonotonicSequenceException : MathIllegalNumberException
    {
        ...
        ///  </returns>
        public virtual MathArrays.OrderDirection Direction
        {
            get
            {
                return direction;
        ...
        public virtual Number Previous
        {
            get
            {
                return previous;
