...
//ORIGINAL LINE: public BicubicSplineInterpolatingFunction interpolate(final double[] xval, final double[] yval, final double[][] fval) throws mathlib.exception.NoDataException, mathlib.exception.DimensionMismatchException, mathlib.exception.NonMonotonicSequenceException, mathlib.exception.NumberIsTooSmallException
...
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final mathlib.analysis.polynomials.PolynomialSplineFunction[] ySplineX = new mathlib.analysis.polynomials.PolynomialSplineFunction[yLen];
...
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final mathlib.analysis.polynomials.PolynomialSplineFunction[] xSplineY = new mathlib.analysis.polynomials.PolynomialSplineFunction[xLen];
...
//ORIGINAL LINE: double[][] dFdX = new double[xLen][yLen];
			...
			{
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final mathlib.analysis.UnivariateFunction f = ySplineX[j].derivative();
...
//ORIGINAL LINE: double[][] dFdY = new double[xLen][yLen];
			...
			{
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final mathlib.analysis.UnivariateFunction f = xSplineY[i].derivative();
