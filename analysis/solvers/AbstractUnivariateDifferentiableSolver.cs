...
namespace mathlib.analysis.solvers
{
    ...
    public abstract class AbstractUnivariateDifferentiableSolver : BaseAbstractUnivariateSolver<UnivariateDifferentiableFunction>, UnivariateDifferentiableSolver
    {
        ...
        protected internal AbstractUnivariateDifferentiableSolver(double absoluteAccuracy)
        ...
        protected internal AbstractUnivariateDifferentiableSolver(double relativeAccuracy, double absoluteAccuracy, double functionValueAccuracy)
