...
namespace mathlib.analysis.differentiation
{
	...
	/// <summary>
	/// Extension of <seealso cref="MultivariateVectorFunction"/> representing a
	...
	/// @since 3.1
	/// </summary>
	public interface MultivariateDifferentiableVectorFunction : MultivariateVectorFunction
	{

		/// <summary>
		/// Compute the value for the function at the given point. </summary>
