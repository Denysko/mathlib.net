...
namespace mathlib.util
{
	...
	/// 
	/// @since 3.0
	/// @version $Id: Pair.java 1591835 2014-05-02 09:04:01Z tn $ </param>
...
//ORIGINAL LINE: public Pair(Pair<? extends K, ? extends V> entry)
		public Pair<T1>(Pair<T1> entry) where T1 : K where ? : V : this(entry.Key, entry.Value)
		{
		}
