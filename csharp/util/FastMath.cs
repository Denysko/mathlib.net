...
namespace org.apache.commons.math3.util
{
	...
	public class FastMath
	{
		...
		private static readonly double[][] LN_QUICK_COEF = new double[][] {new double[] {1.0, 5.669184079525E-24}, new double[] {-0.25, -0.25}, new double[] {0.3333333134651184, 1.986821492305628E-8}, new double[] {-0.25, -6.663542893624021E-14}, new double[] {0.19999998807907104, 1.1921056801463227E-8}, new double[] {-0.1666666567325592, -7.800414592973399E-9}, new double[] {0.1428571343421936, 5.650007086920087E-9}, new double[] {-0.12502530217170715, -7.44321345601866E-11}, new double[] {0.11113807559013367, 9.219544613762692E-9}};

		/// <summary>
		/// Coefficients for log in the range of 1.0 < x < 1.0 + 2^-10. </summary>
		private static readonly double[][] LN_HI_PREC_COEF = new double[][] {new double[] {1.0, -6.032174644509064E-23}, new double[] {-0.25, -0.25}, new double[] {0.3333333134651184, 1.9868161777724352E-8}, new double[] {-0.2499999701976776, -2.957007209750105E-8}, new double[] {0.19999954104423523, 1.5830993332061267E-10}, new double[] {-0.16624879837036133, -2.6033824355191673E-8}};
		...
		/// <summary>
		/// 2^53 - double numbers this large must be even. </summary>
		private static readonly double TWO_POWER_53 = 2 * TWO_POWER_52;
		...
		/// <p><b>Note:</b> this implementation currently delegates to <seealso cref="Math#sqrt"/> </summary>
...
//ORIGINAL LINE: public static float nextUp(final float a)
		...
		/// <p><b>Note:</b> this implementation currently delegates to <seealso cref="Math#random"/> </summary>
...
//ORIGINAL LINE: final double result = exp(lna, z, null);
		...
		public static double pow(double d, int e)
		{
			...
			const int splitFactor = 0x8000001;
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final double cd = splitFactor * d;
			double cd = splitFactor * d;
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final double d1High = cd - (cd - d);
			double d1High = cd - (cd - d);
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final double d1Low = d - d1High;
			...
			while (e != 0)
			{
				...
				if ((e & 0x1) != 0)
				{
					...
					// beware the following expressions must NOT be simplified, they rely on floating point arithmetic properties
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final double tmpHigh = resultHigh * d2p;
					double tmpHigh = resultHigh * d2p;
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final double cRH = splitFactor * resultHigh;
					double cRH = splitFactor * resultHigh;
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final double rHH = cRH - (cRH - resultHigh);
					double rHH = cRH - (cRH - resultHigh);
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final double rHL = resultHigh - rHH;
					double rHL = resultHigh - rHH;
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final double tmpLow = rHL * d2pLow - (((tmpHigh - rHH * d2pHigh) - rHL * d2pHigh) - rHH * d2pLow);
				...
				// beware the following expressions must NOT be simplified, they rely on floating point arithmetic properties
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final double tmpHigh = d2pHigh * d2p;
				double tmpHigh = d2pHigh * d2p;
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final double cD2pH = splitFactor * d2pHigh;
				double cD2pH = splitFactor * d2pHigh;
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final double d2pHH = cD2pH - (cD2pH - d2pHigh);
				double d2pHH = cD2pH - (cD2pH - d2pHigh);
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final double d2pHL = d2pHigh - d2pHH;
				double d2pHL = d2pHigh - d2pHH;
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final double tmpLow = d2pHL * d2pLow - (((tmpHigh - d2pHH * d2pHigh) - d2pHL * d2pHigh) - d2pHH * d2pLow);
				double tmpLow = d2pHL * d2pLow - (((tmpHigh - d2pHH * d2pHigh) - d2pHL * d2pHigh) - d2pHH * d2pLow);
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final double cTmpH = splitFactor * tmpHigh;
				double cTmpH = splitFactor * tmpHigh;
...
//ORIGINAL LINE: final double scaledH = sqrt(scaledX * scaledX + scaledY * scaledY);
		...
		/// </ul>
		/// <p><b>Note:</b> this implementation currently delegates to <seealso cref="StrictMath#IEEEremainder"/> </summary>
...
//ORIGINAL LINE: final long m = Double.doubleToRawLongBits(magnitude);
			long m = double.doubleToRawLongBits(magnitude); // don't care about NaN
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
...
//ORIGINAL LINE: public static int getExponent(final double d)
		public static int getExponent(double d)
		{
			...
			return (int)(((int)((uint)double.doubleToRawLongBits(d) >> 52)) & 0x7ff) - 1023;
		}
...
//ORIGINAL LINE: public static int getExponent(final float f)
		...
		/// <p>used to generate the preset arrays originally.</p> </summary>
