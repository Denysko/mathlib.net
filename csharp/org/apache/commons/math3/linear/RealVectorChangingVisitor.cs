...
namespace org.apache.commons.math3.linear
{
	...
	public interface RealVectorChangingVisitor
	{
		...
		/// <seealso cref="RealVector#walkInDefaultOrder(RealVectorChangingVisitor)"/>,
		/// <seealso cref="RealVector#walkInDefaultOrder(RealVectorChangingVisitor, int, int)"/>,
		/// <seealso cref="RealVector#walkInOptimizedOrder(RealVectorChangingVisitor)"/>
		/// or
		/// <seealso cref="RealVector#walkInOptimizedOrder(RealVectorChangingVisitor, int, int)"/> </returns>
		double end();
	}
