...
namespace org.apache.commons.math3.linear
{
	...
	/// <summary>
	/// Default implementation of the <seealso cref="FieldMatrixChangingVisitor"/> interface.
	/// <p>
	...
	/// @since 2.0 </param>
	public class DefaultFieldMatrixChangingVisitor<T> : FieldMatrixChangingVisitor<T> where T : org.apache.commons.math3.FieldElement<T>
	{
		/// <summary>
...
//ORIGINAL LINE: public DefaultFieldMatrixChangingVisitor(final T zero)
		...
		/// <summary>
		/// {@inheritDoc} </summary>
		public virtual T visit(int row, int column, T value)
		{
			return value;
		}
