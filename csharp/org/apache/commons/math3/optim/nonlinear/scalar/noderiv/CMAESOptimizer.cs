...
namespace org.apache.commons.math3.optim.nonlinear.scalar.noderiv
{
	...
	/// @since 3.0
	/// </summary>
	public class CMAESOptimizer : MultivariateOptimizer
	{
		...
		/// adaptation.
		/// </summary>
		private readonly bool isActiveCMA;
		/// <summary>
		/// Determines how often a new random offspring is generated in case it is
		/// not feasible / beyond the defined limits, default is 0.
		/// </summary>
		private readonly int checkFeasableCount;
		...
		private readonly bool generateStatistics;
		...
		private readonly double stopFitness;
		/// <summary>
		...
		private readonly IList<double?> statisticsSigmaHistory = new List<double?>();
		/// <summary>
		/// History of mean matrix. </summary>
		private readonly IList<RealMatrix> statisticsMeanHistory = new List<RealMatrix>();
		/// <summary>
		/// History of fitness values. </summary>
		private readonly IList<double?> statisticsFitnessHistory = new List<double?>();
		/// <summary>
		/// History of D matrix. </summary>
		private readonly IList<RealMatrix> statisticsDHistory = new List<RealMatrix>();
...
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in .NET:
//ORIGINAL LINE: @Override public org.apache.commons.math3.optim.PointValuePair optimize(org.apache.commons.math3.optim.OptimizationData... optData) throws org.apache.commons.math3.exception.TooManyEvaluationsException, org.apache.commons.math3.exception.DimensionMismatchException
...
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final ValuePenaltyPair[] valuePenaltyPairs = new ValuePenaltyPair[lambda];
				ValuePenaltyPair[] valuePenaltyPairs = new ValuePenaltyPair[lambda];
...
//ORIGINAL LINE: final double historyWorst = max(fitnessHistory);
				...
				{
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final org.apache.commons.math3.optim.PointValuePair current = new org.apache.commons.math3.optim.PointValuePair(bestArx.getColumn(0), isMinimize ? bestFitness : -bestFitness);
...
//ORIGINAL LINE: final int[] indices = new int[doubles.length];
	   ...
	   /// Get range of values.
	   /// </summary>
	   /// <param name="vpPairs"> Array of valuePenaltyPairs to get range from. </param>
	   /// <returns> a double equal to maximum value minus minimum value. </returns>
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: private double valueRange(final ValuePenaltyPair[] vpPairs)
		private double valueRange(ValuePenaltyPair[] vpPairs)
		{
			double max = double.NegativeInfinity;
			double min = double.MaxValue;
			foreach (ValuePenaltyPair vpPair in vpPairs)
			{
				if (vpPair.value > max)
				{
					max = vpPair.value;
		...
		/// </summary>
		private class ValuePenaltyPair
		{
			/// <summary>
			/// Objective function value. </summary>
			internal double value;
			/// <summary>
			/// Penalty value for repair of out out of bounds points. </summary>
			internal double penalty;

			/// <param name="value"> Function value. </param>
			/// <param name="penalty"> Out-of-bounds penalty. </param>
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public ValuePenaltyPair(final double value, final double penalty)
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public ValuePenaltyPair value(final double[] point)
			public virtual ValuePenaltyPair value(double[] point)
			{
				double value;
				double penalty = 0.0;
				if (isRepairMode)
				{
					...
					value = outerInstance.computeObjectiveValue(repaired);
				...
				value = outerInstance.isMinimize ? value : -value;
				penalty = outerInstance.isMinimize ? penalty : -penalty;
