...
namespace org.apache.commons.math3.genetics
{
	...
	/// @since 2.0
	/// @version $Id: PermutationChromosome.java 1416643 2012-12-03 19:37:14Z tn $ </param>
	public interface PermutationChromosome<T>
	{
		...
		/// </summary>
		/// <param name="sequence"> the unpermuted (original) sequence of objects </param>
		/// <returns> permutation of <code>sequence</code> represented by this permutation </returns>
		IList<T> decode(IList<T> sequence);
