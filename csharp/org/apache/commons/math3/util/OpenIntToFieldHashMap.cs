...
namespace org.apache.commons.math3.util
{
	...
	/// modified during iteration.</p> </summary>
	...
	public class OpenIntToFieldHashMap<T> where T : org.apache.commons.math3.FieldElement<T>
	{
		...
		private const long serialVersionUID = -9179080286849120720L;
		...
		private readonly T missingEntries;
...
//ORIGINAL LINE: public OpenIntToFieldHashMap(final org.apache.commons.math3.Field<T>field)
		public OpenIntToFieldHashMap(Field<T>field) : this(field, DEFAULT_EXPECTED_SIZE, field.Zero)
		{
		}
...
//ORIGINAL LINE: public OpenIntToFieldHashMap(final org.apache.commons.math3.Field<T>field, final T missingEntries)
		public OpenIntToFieldHashMap(Field<T>field, T missingEntries) : this(field,DEFAULT_EXPECTED_SIZE, missingEntries)
		{
		}

		/// <summary>
		/// Build an empty map with specified size and using zero for missing entries. </summary>
		/// <param name="field"> field to which the elements belong </param>
...
//ORIGINAL LINE: public OpenIntToFieldHashMap(final org.apache.commons.math3.Field<T> field,final int expectedSize)
		public OpenIntToFieldHashMap(Field<T> field, int expectedSize) : this(field,expectedSize, field.Zero)
		{
		}
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public OpenIntToFieldHashMap(final OpenIntToFieldHashMap<T> source)
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public T get(final int key)
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public T remove(final int key)
...
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final T previous = values[index];
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public T put(final int key, final T value)
...
//ORIGINAL LINE: final int[] oldKeys = keys;
			int[] oldKeys = keys;
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final T[] oldValues = values;
			T[] oldValues = values;
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
...
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final T[] newValues = buildArray(newLength);
...
//ORIGINAL LINE: final int h = key ^ ((key >>> 20) ^ (key >>> 12));
		...
		{
			private readonly OpenIntToFieldHashMap outerInstance;
			...
			/// Simple constructor.
			/// </summary>
			internal Iterator(OpenIntToFieldHashMap outerInstance)
			{
...
//ORIGINAL LINE: public int key() throws java.util.ConcurrentModificationException, java.util.NoSuchElementException
			...
			/// <exception cref="NoSuchElementException"> if there is no element left in the map </exception>
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in .NET:
//ORIGINAL LINE: public T value() throws java.util.ConcurrentModificationException, java.util.NoSuchElementException
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
		...
		/// <summary>
		/// Build an array of elements. </summary>
		/// <param name="length"> size of the array to build </param>
		/// <returns> a new array </returns>
//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
//ORIGINAL LINE: @SuppressWarnings("unchecked") private T[] buildArray(final int length)
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
		private T[] buildArray(int length) // field is of type T
		{
			return (T[]) Array.newInstance(field.RuntimeClass, length);
		}
