...
namespace org.apache.commons.math3.exception
{
	...
	public class MathParseException : MathIllegalStateException, ExceptionContextProvider
	{
		...
		{
			Context.addMessage(LocalizedFormats.CANNOT_PARSE_AS_TYPE, wrong, Convert.ToInt32(position), type.Name);
		}
		...
		{
			Context.addMessage(LocalizedFormats.CANNOT_PARSE, wrong, Convert.ToInt32(position));
		}
	}
