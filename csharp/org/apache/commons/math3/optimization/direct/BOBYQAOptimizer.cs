...
namespace org.apache.commons.math3.optimization.direct
{
	...
	/// finite differences.
	/// 
	/// @version $Id: BOBYQAOptimizer.java 1540165 2013-11-08 19:53:58Z tn $ </summary>
	/// @deprecated As of 3.1 (to be removed in 4.0).
	/// @since 3.0 
	[Obsolete("As of 3.1 (to be removed in 4.0).")]
	public class BOBYQAOptimizer : BaseAbstractMultivariateSimpleBoundsOptimizer<MultivariateFunction>, MultivariateOptimizer
	{
		/// <summary>
