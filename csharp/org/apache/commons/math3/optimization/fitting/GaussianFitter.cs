...
namespace org.apache.commons.math3.optimization.fitting
{
	...
	/// 
	/// @since 2.2
	/// @version $Id: GaussianFitter.java 1422230 2012-12-15 12:11:13Z erans $ </summary>
	...
	public class GaussianFitter : CurveFitter<Gaussian.Parametric>
	{
		...
		public GaussianFitter(DifferentiableMultivariateVectorOptimizer optimizer) : base(optimizer)
		{
		}
