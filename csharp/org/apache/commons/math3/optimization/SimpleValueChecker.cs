...
namespace org.apache.commons.math3.optimization
{
	...
	/// <br/>
	/// The <seealso cref="#converged(int,PointValuePair,PointValuePair) converged"/>
	/// method will also return {@code true} if the number of iterations has been set
	/// (see <seealso cref="#SimpleValueChecker(double,double,int) this constructor"/>).
	/// 
	/// @version $Id: SimpleValueChecker.java 1591835 2014-05-02 09:04:01Z tn $ </summary>
	/// @deprecated As of 3.1 (to be removed in 4.0).
	/// @since 3.0 
	[Obsolete("As of 3.1 (to be removed in 4.0).")]
	public class SimpleValueChecker : AbstractConvergenceChecker<PointValuePair>
	{
		/// <summary>
		/// If <seealso cref="#maxIterationCount"/> is set to this value, the number of
		/// iterations will never cause
		/// <seealso cref="#converged(int,PointValuePair,PointValuePair)"/>
		/// to return {@code true}.
		/// </summary>
		private const int ITERATION_CHECK_DISABLED = -1;
		/// <summary>
		/// Number of iterations after which the
		/// <seealso cref="#converged(int,PointValuePair,PointValuePair)"/> method
...
//ORIGINAL LINE: public SimpleValueChecker(final double relativeThreshold, final double absoluteThreshold)
		public SimpleValueChecker(double relativeThreshold, double absoluteThreshold) : base(relativeThreshold, absoluteThreshold)
		{
			maxIterationCount = ITERATION_CHECK_DISABLED;
		}
		...
		/// @since 3.1 </exception>
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public SimpleValueChecker(final double relativeThreshold, final double absoluteThreshold, final int maxIter)
		public SimpleValueChecker(double relativeThreshold, double absoluteThreshold, int maxIter) : base(relativeThreshold, absoluteThreshold)
		{
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: @Override public boolean converged(final int iteration, final PointValuePair previous, final PointValuePair current)
		public override bool converged(int iteration, PointValuePair previous, PointValuePair current)
		{
