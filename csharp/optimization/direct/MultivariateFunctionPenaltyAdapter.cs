...
namespace org.apache.commons.math3.optimization.direct
{
	...
	/// <seealso cref="BOBYQAOptimizer"/>. One caveat of this poor man solution is that if start point
	...
	/// </p>
	/// </summary>
	/// <seealso cref= MultivariateFunctionMappingAdapter
	/// 
	/// @version $Id: MultivariateFunctionPenaltyAdapter.java 1422230 2012-12-15 12:11:13Z erans $ </seealso>
	/// @deprecated As of 3.1 (to be removed in 4.0).
	/// @since 3.0 

	[Obsolete]
	public class MultivariateFunctionPenaltyAdapter : MultivariateFunction
	{
		...
		/// <summary>
		/// Penalty offset. </summary>
		private readonly double offset;

		/// <summary>
		/// Penalty scales. </summary>
		...
		/// unbounded values) </param>
		/// <param name="offset"> base offset of the penalty function </param>
		/// <param name="scale"> scale of the penalty function </param>
		/// <exception cref="DimensionMismatchException"> if lower bounds, upper bounds and
...
//ORIGINAL LINE: public MultivariateFunctionPenaltyAdapter(final org.apache.commons.math3.analysis.MultivariateFunction bounded, final double[] lower, final double[] upper, final double offset, final double[] scale)
		...
		/// </p> </summary>
		/// <param name="point"> unbounded point </param>
		/// <returns> either underlying function value or penalty function value </returns>
...
//ORIGINAL LINE: final double overshoot;
						double overshoot;
						if (point[j] < lower[j])
						{
