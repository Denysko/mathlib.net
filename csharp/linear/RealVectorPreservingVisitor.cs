...
namespace org.apache.commons.math3.linear
{
	...
	/// visited.
	/// 
	/// @version $Id: RealVectorPreservingVisitor.java 1416643 2012-12-03 19:37:14Z tn $
	/// @since 3.1
	/// </summary>
	public interface RealVectorPreservingVisitor
	{
		...
		/// <seealso cref="RealVector#walkInDefaultOrder(RealVectorPreservingVisitor)"/>,
		/// <seealso cref="RealVector#walkInDefaultOrder(RealVectorPreservingVisitor, int, int)"/>,
		/// <seealso cref="RealVector#walkInOptimizedOrder(RealVectorPreservingVisitor)"/>
		/// or
		/// <seealso cref="RealVector#walkInOptimizedOrder(RealVectorPreservingVisitor, int, int)"/> </returns>
		double end();
	}
