...
namespace mathlib.genetics
{
	...
	public interface StoppingCondition
	{
		...
		/// </summary>
		/// <param name="population"> the population to test. </param>
		/// <returns> <code>true</code> if this stopping condition is met by the given population,
		///   <code>false</code> otherwise. </returns>
		bool isSatisfied(Population population);
	}
