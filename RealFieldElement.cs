...
namespace mathlib
{
    ...
    /// <a href="http://mathworld.wolfram.com/Field.html">field</a>. </summary>
    ...
    public interface RealFieldElement<T> : FieldElement<T>
    {
        ...
        /// <summary>
        /// Get the real value of the number. </summary>
        ...
        /// <summary>
        /// '&times;' operator. </summary>
        /// <param name="a"> right hand side parameter of the operator </param>
        /// <returns> this&times;a </returns>
        T multiply(double a);

        /// <summary>
        /// '&divide;' operator. </summary>
        /// <param name="a"> right hand side parameter of the operator </param>
        /// <returns> this&divides;a </returns>
        T divide(double a);

        /// <summary>
        /// IEEE remainder operator. </summary>
        /// <param name="a"> right hand side parameter of the operator </param>
        ...
        /// <summary>
        /// Get the smallest whole number larger than instance. </summary>
        /// <returns> ceil(this) </returns>
        T ceil();

        /// <summary>
        /// Get the largest whole number smaller than instance. </summary>
        /// <returns> floor(this) </returns>
        T floor();

        /// <summary>
        /// Get the whole number that is the nearest to the instance, or the even one if x is exactly half way between two integers. </summary>
        /// <returns> a double number r such that r is an integer r - 0.5 <= this <= r + 0.5 </returns>
        T rint();

        /// <summary>
        /// Get the closest long to instance value. </summary>
        /// <returns> closest long to <seealso cref="#getReal()"/> </returns>
        long round();
        ...
        /// <summary>
        /// Multiply the instance by a power of 2. </summary>
        ...
        /// <summary>
        /// Shifted natural logarithm. </summary>
        ...
        /// <summary>
        /// Cosine operation. </summary>
        /// <returns> cos(this) </returns>
        T cos();

        /// <summary>
        /// Sine operation. </summary>
        /// <returns> sin(this) </returns>
        T sin();

        /// <summary>
        /// Tangent operation. </summary>
        /// <returns> tan(this) </returns>
        T tan();

        /// <summary>
        /// Arc cosine operation. </summary>
        /// <returns> acos(this) </returns>
        T acos();

        /// <summary>
        /// Arc sine operation. </summary>
        /// <returns> asin(this) </returns>
        T asin();

        /// <summary>
        /// Arc tangent operation. </summary>
        ...
        /// <summary>
        /// Hyperbolic cosine operation. </summary>
        /// <returns> cosh(this) </returns>
        T cosh();

        /// <summary>
        /// Hyperbolic sine operation. </summary>
        /// <returns> sinh(this) </returns>
        T sinh();

        /// <summary>
        /// Hyperbolic tangent operation. </summary>
        /// <returns> tanh(this) </returns>
        T tanh();

        /// <summary>
        /// Inverse hyperbolic cosine operation. </summary>
        /// <returns> acosh(this) </returns>
        T acosh();

        /// <summary>
        /// Inverse hyperbolic sine operation. </summary>
        /// <returns> asin(this) </returns>
        T asinh();

        /// <summary>
        /// Inverse hyperbolic  tangent operation. </summary>
        /// <returns> atanh(this) </returns>
        T atanh();

        /// <summary>
        /// Compute a linear combination. </summary>
        ...
        /// <seealso cref= #linearCombination(Object, Object, Object, Object, Object, Object) </seealso>
        /// <seealso cref= #linearCombination(Object, Object, Object, Object, Object, Object, Object, Object)
        /// @since 3.2 </seealso>
        ...
        /// <returns> a<sub>1</sub>&times;b<sub>1</sub> +
        /// a<sub>2</sub>&times;b<sub>2</sub> </returns>
        /// <seealso cref= #linearCombination(double, Object, double, Object, double, Object) </seealso>
        /// <seealso cref= #linearCombination(double, Object, double, Object, double, Object, double, Object)
        /// @since 3.2 </seealso>
        ...
        /// <seealso cref= #linearCombination(Object, Object, Object, Object) </seealso>
        /// <seealso cref= #linearCombination(Object, Object, Object, Object, Object, Object, Object, Object)
        /// @since 3.2 </seealso>
        ...
        /// <returns> a<sub>1</sub>&times;b<sub>1</sub> +
        /// a<sub>2</sub>&times;b<sub>2</sub> + a<sub>3</sub>&times;b<sub>3</sub> </returns>
        /// <seealso cref= #linearCombination(double, Object, double, Object) </seealso>
        /// <seealso cref= #linearCombination(double, Object, double, Object, double, Object, double, Object)
        /// @since 3.2 </seealso>
        ...
        /// <seealso cref= #linearCombination(Object, Object, Object, Object) </seealso>
        /// <seealso cref= #linearCombination(Object, Object, Object, Object, Object, Object)
        /// @since 3.2 </seealso>
        ...
        /// a<sub>4</sub>&times;b<sub>4</sub> </returns>
        /// <seealso cref= #linearCombination(double, Object, double, Object) </seealso>
        /// <seealso cref= #linearCombination(double, Object, double, Object, double, Object)
        /// @since 3.2 </seealso>
