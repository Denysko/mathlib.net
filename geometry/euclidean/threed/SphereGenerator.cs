...
namespace org.apache.commons.math3.geometry.euclidean.threed
{
	...
	using org.apache.commons.math3.geometry.enclosing;
	using DiskGenerator = org.apache.commons.math3.geometry.euclidean.twod.DiskGenerator;
...
//ORIGINAL LINE: public org.apache.commons.math3.geometry.enclosing.EnclosingBall<Euclidean3D, Vector3D> ballOnSupport(final java.util.List<Vector3D> support)
...
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final org.apache.commons.math3.fraction.BigFraction[] c2 = new org.apache.commons.math3.fraction.BigFraction[] { new org.apache.commons.math3.fraction.BigFraction(vA.getX()), new org.apache.commons.math3.fraction.BigFraction(vB.getX()), new org.apache.commons.math3.fraction.BigFraction(vC.getX()), new org.apache.commons.math3.fraction.BigFraction(vD.getX()) };
							BigFraction[] c2 = new BigFraction[] {new BigFraction(vA.X), new BigFraction(vB.X), new BigFraction(vC.X), new BigFraction(vD.X)};
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final org.apache.commons.math3.fraction.BigFraction[] c3 = new org.apache.commons.math3.fraction.BigFraction[] { new org.apache.commons.math3.fraction.BigFraction(vA.getY()), new org.apache.commons.math3.fraction.BigFraction(vB.getY()), new org.apache.commons.math3.fraction.BigFraction(vC.getY()), new org.apache.commons.math3.fraction.BigFraction(vD.getY()) };
							BigFraction[] c3 = new BigFraction[] {new BigFraction(vA.Y), new BigFraction(vB.Y), new BigFraction(vC.Y), new BigFraction(vD.Y)};
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final org.apache.commons.math3.fraction.BigFraction[] c4 = new org.apache.commons.math3.fraction.BigFraction[] { new org.apache.commons.math3.fraction.BigFraction(vA.getZ()), new org.apache.commons.math3.fraction.BigFraction(vB.getZ()), new org.apache.commons.math3.fraction.BigFraction(vC.getZ()), new org.apache.commons.math3.fraction.BigFraction(vD.getZ()) };
							BigFraction[] c4 = new BigFraction[] {new BigFraction(vA.Z), new BigFraction(vB.Z), new BigFraction(vC.Z), new BigFraction(vD.Z)};
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final org.apache.commons.math3.fraction.BigFraction[] c1 = new org.apache.commons.math3.fraction.BigFraction[] { c2[0].multiply(c2[0]).add(c3[0].multiply(c3[0])).add(c4[0].multiply(c4[0])), c2[1].multiply(c2[1]).add(c3[1].multiply(c3[1])).add(c4[1].multiply(c4[1])), c2[2].multiply(c2[2]).add(c3[2].multiply(c3[2])).add(c4[2].multiply(c4[2])), c2[3].multiply(c2[3]).add(c3[3].multiply(c3[3])).add(c4[3].multiply(c4[3])) };
...
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final org.apache.commons.math3.fraction.BigFraction twoM11 = minor(c2, c3, c4).multiply(2);
							BigFraction twoM11 = minor(c2, c3, c4).multiply(2);
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final org.apache.commons.math3.fraction.BigFraction m12 = minor(c1, c3, c4);
							BigFraction m12 = minor(c1, c3, c4);
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final org.apache.commons.math3.fraction.BigFraction m13 = minor(c1, c2, c4);
							BigFraction m13 = minor(c1, c2, c4);
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final org.apache.commons.math3.fraction.BigFraction m14 = minor(c1, c2, c3);
...
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final org.apache.commons.math3.fraction.BigFraction centerZ = m14.divide(twoM11);
...
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final org.apache.commons.math3.fraction.BigFraction dz = c4[0].subtract(centerZ);
							BigFraction dz = c4[0].subtract(centerZ);
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final org.apache.commons.math3.fraction.BigFraction r2 = dx.multiply(dx).add(dy.multiply(dy)).add(dz.multiply(dz));
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: private org.apache.commons.math3.fraction.BigFraction minor(final org.apache.commons.math3.fraction.BigFraction[] c1, final org.apache.commons.math3.fraction.BigFraction[] c2, final org.apache.commons.math3.fraction.BigFraction[] c3)
