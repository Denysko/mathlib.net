...
//ORIGINAL LINE: public Circle(final mathlib.geometry.euclidean.threed.Vector3D pole, final double tolerance)
...
//ORIGINAL LINE: public Circle(final S2Point first, final S2Point second, final double tolerance)
		...
		/// <param name="tolerance"> tolerance below which close sub-arcs are merged together </param>
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: private Circle(final mathlib.geometry.euclidean.threed.Vector3D pole, final mathlib.geometry.euclidean.threed.Vector3D x, final mathlib.geometry.euclidean.threed.Vector3D y, final double tolerance)
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public void reset(final mathlib.geometry.euclidean.threed.Vector3D newPole)
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public mathlib.geometry.spherical.oned.S1Point toSubSpace(final mathlib.geometry.Point<Sphere2D> point)
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public double getPhase(final mathlib.geometry.euclidean.threed.Vector3D direction)
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public S2Point toSpace(final mathlib.geometry.Point<mathlib.geometry.spherical.oned.Sphere1D> point)
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public mathlib.geometry.spherical.oned.Arc getInsideArc(final Circle other)
...
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final double halfPi = 0.5 * mathlib.util.FastMath.PI;
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public double getOffset(final mathlib.geometry.Point<Sphere2D> point)
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public double getOffset(final mathlib.geometry.euclidean.threed.Vector3D direction)
		...
		/// {@inheritDoc} </summary>
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public boolean sameOrientationAs(final mathlib.geometry.partitioning.Hyperplane<Sphere2D> other)
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static mathlib.geometry.partitioning.Transform<Sphere2D, mathlib.geometry.spherical.oned.Sphere1D> getTransform(final mathlib.geometry.euclidean.threed.Rotation rotation)
		...
		private class CircleTransform : Transform<Sphere2D, Sphere1D>
		{
			...
			/// <param name="rotation"> rotation to use </param>
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public CircleTransform(final mathlib.geometry.euclidean.threed.Rotation rotation)
			...
			/// {@inheritDoc} </summary>
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public S2Point apply(final mathlib.geometry.Point<Sphere2D> point)
			...
			/// {@inheritDoc} </summary>
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public Circle apply(final mathlib.geometry.partitioning.Hyperplane<Sphere2D> hyperplane)
...
//ORIGINAL LINE: final Circle circle = (Circle) hyperplane;
			...
			/// {@inheritDoc} </summary>
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public mathlib.geometry.partitioning.SubHyperplane<mathlib.geometry.spherical.oned.Sphere1D> apply(final mathlib.geometry.partitioning.SubHyperplane<mathlib.geometry.spherical.oned.Sphere1D> sub, final mathlib.geometry.partitioning.Hyperplane<Sphere2D> original, final mathlib.geometry.partitioning.Hyperplane<Sphere2D> transformed)
