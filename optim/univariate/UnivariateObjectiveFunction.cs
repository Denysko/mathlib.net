...
namespace org.apache.commons.math3.optim.univariate
{
	...
	/// @since 3.1
	/// </summary>
	public class UnivariateObjectiveFunction : OptimizationData
	{
		/// <summary>
		/// Function to be optimized. </summary>
		private readonly UnivariateFunction function;
		...
		public virtual UnivariateFunction ObjectiveFunction
		{
			get
			{
				return function;
