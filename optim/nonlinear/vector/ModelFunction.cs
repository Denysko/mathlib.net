...
namespace mathlib.optim.nonlinear.vector
{
	...
	/// 
	/// @version $Id: ModelFunction.java 1515242 2013-08-18 23:27:29Z erans $
	/// @since 3.1 </summary>
	...
	public class ModelFunction : OptimizationData
	{
		/// <summary>
		/// Function to be optimized. </summary>
		private readonly MultivariateVectorFunction model;

		/// <param name="m"> Model function to be optimized. </param>
		...
		/// </summary>
		/// <returns> the model function. </returns>
