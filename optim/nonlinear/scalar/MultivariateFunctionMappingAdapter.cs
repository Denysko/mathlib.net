...
//ORIGINAL LINE: public MultivariateFunctionMappingAdapter(final mathlib.analysis.MultivariateFunction bounded, final double[] lower, final double[] upper)
		...
		/// </summary>
		/// <param name="point"> Unbounded values. </param>
		/// <returns> the bounded values. </returns>
...
//ORIGINAL LINE: final double[] mapped = new double[mappers.length];
		...
		/// </summary>
		/// <param name="point"> Bounded values. </param>
		/// <returns> the unbounded values. </returns>
...
//ORIGINAL LINE: final double[] mapped = new double[mappers.length];
		...
		private interface Mapper
		{
			...
			/// <returns> the unbounded value. </returns>
