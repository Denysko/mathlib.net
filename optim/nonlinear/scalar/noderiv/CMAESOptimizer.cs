...
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in .NET:
//ORIGINAL LINE: @Override public mathlib.optim.PointValuePair optimize(mathlib.optim.OptimizationData... optData) throws mathlib.exception.TooManyEvaluationsException, mathlib.exception.DimensionMismatchException
...
//ORIGINAL LINE: final double historyWorst = max(fitnessHistory);
				...
				{
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final mathlib.optim.PointValuePair current = new mathlib.optim.PointValuePair(bestArx.getColumn(0), isMinimize ? bestFitness : -bestFitness);
