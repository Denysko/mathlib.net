...
namespace mathlib.optim
{
	...
	/// @since 3.1
	/// </summary>
	public class MaxEval : OptimizationData
	{
		/// <summary>
		/// Allowed number of evalutations. </summary>
		private readonly int maxEval;

		/// <param name="max"> Allowed number of evalutations. </param>
		...
		{
			return new MaxEval(int.MaxValue);
		}
	}
