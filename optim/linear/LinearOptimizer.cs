...
namespace mathlib.optim.linear
{
    ...
    public abstract class LinearOptimizer : MultivariateOptimizer
    {
        ...
        /// </summary>
        protected internal LinearOptimizer()
            : base(null) // No convergence checker.
        {
        }

        /// <returns> 
        /// {@code true} if the variables are restricted to non-negative values. 
        /// </returns>
        ...
        protected internal virtual ICollection<LinearConstraint> Constraints
        {
            //get
            //{
            //    return System.Collections.unmodifiableCollection(linearConstraints);
            //}
        }
