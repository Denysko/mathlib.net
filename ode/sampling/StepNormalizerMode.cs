...
namespace mathlib.ode.sampling
{
	...
	/// <summary>
	/// <seealso cref="StepNormalizer Step normalizer"/> modes. Determines how the step size
	/// is interpreted. </summary>
	/// <seealso cref= StepNormalizer </seealso>
	/// <seealso cref= StepNormalizerBounds
	/// @version $Id: StepNormalizerMode.java 1416643 2012-12-03 19:37:14Z tn $
	/// @since 3.0 </seealso>
	public enum StepNormalizerMode
	{
		...
		/// the <seealso cref="StepNormalizerBounds bounds settings"/>), t0+h, t0+2h, ...</p>
		/// 
		...
		/// tend], depending on the <seealso cref="StepNormalizerBounds bounds settings"/>.
		/// </p>
		/// </summary>
		/// <seealso cref= StepNormalizer </seealso>
		/// <seealso cref= StepNormalizerBounds </seealso>
		INCREMENT,
		...
		/// (depending on the <seealso cref="StepNormalizerBounds bounds settings"/>), t1,
		/// t1+h, t1+2h, ...</p>
		/// 
		...
		/// <seealso cref="StepNormalizerBounds bounds settings"/>.</p>
		/// </summary>
		/// <seealso cref= StepNormalizer </seealso>
		/// <seealso cref= StepNormalizerBounds </seealso>
		MULTIPLES
