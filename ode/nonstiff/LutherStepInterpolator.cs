...
namespace mathlib.ode.nonstiff
{
	...
	internal class LutherStepInterpolator : RungeKuttaStepInterpolator
	{

		/// <summary>
		/// Serializable version identifier </summary>
		private const long serialVersionUID = 20140416L;

		/// <summary>
		/// Square root. </summary>
		private static readonly double Q = FastMath.sqrt(21);
...
//ORIGINAL LINE: public LutherStepInterpolator(final LutherStepInterpolator interpolator)
		public LutherStepInterpolator(LutherStepInterpolator interpolator) : base(interpolator)
		{
		}
...
//ORIGINAL LINE: final double coeffDot1 = 1 + theta * (-54 / 5.0 + theta * (36 + theta * (-47 + theta * 21)));
			double coeffDot1 = 1 + theta * (-54 / 5.0 + theta * (36 + theta * (-47 + theta * 21)));
			const double coeffDot2 = 0;
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final double coeffDot3 = theta * (-208 / 15.0 + theta * (320 / 3.0 + theta * (-608 / 3.0 + theta * 112)));
			double coeffDot3 = theta * (-208 / 15.0 + theta * (320 / 3.0 + theta * (-608 / 3.0 + theta * 112)));
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final double coeffDot4 = theta * (324 / 25.0 + theta * (-486 / 5.0 + theta * (972 / 5.0 + theta * -567 / 5.0)));
			double coeffDot4 = theta * (324 / 25.0 + theta * (-486 / 5.0 + theta * (972 / 5.0 + theta * -567 / 5.0)));
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final double coeffDot5 = theta * ((833 + 343 * Q) / 150.0 + theta * ((-637 - 357 * Q) / 30.0 + theta * ((392 + 287 * Q) / 15.0 + theta * (-49 - 49 * Q) / 5.0)));
			double coeffDot5 = theta * ((833 + 343 * Q) / 150.0 + theta * ((-637 - 357 * Q) / 30.0 + theta * ((392 + 287 * Q) / 15.0 + theta * (-49 - 49 * Q) / 5.0)));
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final double coeffDot6 = theta * ((833 - 343 * Q) / 150.0 + theta * ((-637 + 357 * Q) / 30.0 + theta * ((392 - 287 * Q) / 15.0 + theta * (-49 + 49 * Q) / 5.0)));
			double coeffDot6 = theta * ((833 - 343 * Q) / 150.0 + theta * ((-637 + 357 * Q) / 30.0 + theta * ((392 - 287 * Q) / 15.0 + theta * (-49 + 49 * Q) / 5.0)));
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final double coeffDot7 = theta * (3 / 5.0 + theta * (-3 + theta * 3));
			double coeffDot7 = theta * (3 / 5.0 + theta * (-3 + theta * 3));

			if ((previousState != null) && (theta <= 0.5))
			{

//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final double coeff1 = 1 + theta * (-27 / 5.0 + theta * (12 + theta * (-47 / 4.0 + theta * 21 / 5.0)));
				double coeff1 = 1 + theta * (-27 / 5.0 + theta * (12 + theta * (-47 / 4.0 + theta * 21 / 5.0)));
				const double coeff2 = 0;
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final double coeff3 = theta * (-104 / 15.0 + theta * (320 / 9.0 + theta * (-152 / 3.0 + theta * 112 / 5.0)));
				double coeff3 = theta * (-104 / 15.0 + theta * (320 / 9.0 + theta * (-152 / 3.0 + theta * 112 / 5.0)));
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final double coeff4 = theta * (162 / 25.0 + theta * (-162 / 5.0 + theta * (243 / 5.0 + theta * -567 / 25.0)));
				double coeff4 = theta * (162 / 25.0 + theta * (-162 / 5.0 + theta * (243 / 5.0 + theta * -567 / 25.0)));
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final double coeff5 = theta * ((833 + 343 * Q) / 300.0 + theta * ((-637 - 357 * Q) / 90.0 + theta * ((392 + 287 * Q) / 60.0 + theta * (-49 - 49 * Q) / 25.0)));
				double coeff5 = theta * ((833 + 343 * Q) / 300.0 + theta * ((-637 - 357 * Q) / 90.0 + theta * ((392 + 287 * Q) / 60.0 + theta * (-49 - 49 * Q) / 25.0)));
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final double coeff6 = theta * ((833 - 343 * Q) / 300.0 + theta * ((-637 + 357 * Q) / 90.0 + theta * ((392 - 287 * Q) / 60.0 + theta * (-49 + 49 * Q) / 25.0)));
				double coeff6 = theta * ((833 - 343 * Q) / 300.0 + theta * ((-637 + 357 * Q) / 90.0 + theta * ((392 - 287 * Q) / 60.0 + theta * (-49 + 49 * Q) / 25.0)));
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final double coeff7 = theta * (3 / 10.0 + theta * (-1 + theta * (3 / 4.0)));
				double coeff7 = theta * (3 / 10.0 + theta * (-1 + theta * (3 / 4.0)));
...
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final double yDot5 = yDotK[4][i];
					double yDot5 = yDotK[4][i];
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
...
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final double coeff1 = -1 / 20.0 + theta * (19 / 20.0 + theta * (-89 / 20.0 + theta * (151 / 20.0 + theta * -21 / 5.0)));
				double coeff1 = -1 / 20.0 + theta * (19 / 20.0 + theta * (-89 / 20.0 + theta * (151 / 20.0 + theta * -21 / 5.0)));
				const double coeff2 = 0;
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final double coeff3 = -16 / 45.0 + theta * (-16 / 45.0 + theta * (-328 / 45.0 + theta * (424 / 15.0 + theta * -112 / 5.0)));
				double coeff3 = -16 / 45.0 + theta * (-16 / 45.0 + theta * (-328 / 45.0 + theta * (424 / 15.0 + theta * -112 / 5.0)));
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final double coeff4 = theta * (theta * (162 / 25.0 + theta * (-648 / 25.0 + theta * 567 / 25.0)));
				double coeff4 = theta * (theta * (162 / 25.0 + theta * (-648 / 25.0 + theta * 567 / 25.0)));
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final double coeff5 = -49 / 180.0 + theta * (-49 / 180.0 + theta * ((2254 + 1029 * Q) / 900.0 + theta * ((-1372 - 847 * Q) / 300.0 + theta * (49 + 49 * Q) / 25.0)));
				double coeff5 = -49 / 180.0 + theta * (-49 / 180.0 + theta * ((2254 + 1029 * Q) / 900.0 + theta * ((-1372 - 847 * Q) / 300.0 + theta * (49 + 49 * Q) / 25.0)));
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final double coeff6 = -49 / 180.0 + theta * (-49 / 180.0 + theta * ((2254 - 1029 * Q) / 900.0 + theta * ((-1372 + 847 * Q) / 300.0 + theta * (49 - 49 * Q) / 25.0)));
				double coeff6 = -49 / 180.0 + theta * (-49 / 180.0 + theta * ((2254 - 1029 * Q) / 900.0 + theta * ((-1372 + 847 * Q) / 300.0 + theta * (49 - 49 * Q) / 25.0)));
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final double coeff7 = -1 / 20.0 + theta * (-1 / 20.0 + theta * (1 / 4.0 + theta * (-3 / 4.0)));
				double coeff7 = -1 / 20.0 + theta * (-1 / 20.0 + theta * (1 / 4.0 + theta * (-3 / 4.0)));
				for (int i = 0; i < interpolatedState.Length; ++i)
				{
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final double yDot1 = yDotK[0][i];
