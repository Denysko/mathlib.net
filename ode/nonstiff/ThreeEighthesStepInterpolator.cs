...
namespace mathlib.ode.nonstiff
{
	...
	/// step.</p>
	/// </summary>
	/// <seealso cref= ThreeEighthesIntegrator
	/// @version $Id: ThreeEighthesStepInterpolator.java 1416643 2012-12-03 19:37:14Z tn $
	/// @since 1.2 </seealso>

	internal class ThreeEighthesStepInterpolator : RungeKuttaStepInterpolator
	{
...
//ORIGINAL LINE: public ThreeEighthesStepInterpolator(final ThreeEighthesStepInterpolator interpolator)
	  public ThreeEighthesStepInterpolator(ThreeEighthesStepInterpolator interpolator) : base(interpolator)
	  {
	  }
...
//ORIGINAL LINE: final double coeffDot3 = 0.75 * theta;
		  double coeffDot3 = 0.75 * theta;
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final double coeffDot1 = coeffDot3 * (4 * theta - 5) + 1;
		  double coeffDot1 = coeffDot3 * (4 * theta - 5) + 1;
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final double coeffDot2 = coeffDot3 * (5 - 6 * theta);
		  double coeffDot2 = coeffDot3 * (5 - 6 * theta);
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final double coeffDot4 = coeffDot3 * (2 * theta - 1);
		  double coeffDot4 = coeffDot3 * (2 * theta - 1);

		  if ((previousState != null) && (theta <= 0.5))
		  {
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final double s = theta * h / 8.0;
			  double s = theta * h / 8.0;
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final double fourTheta2 = 4 * theta * theta;
			  double fourTheta2 = 4 * theta * theta;
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final double coeff1 = s * (8 - 15 * theta + 2 * fourTheta2);
			  double coeff1 = s * (8 - 15 * theta + 2 * fourTheta2);
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final double coeff2 = 3 * s * (5 * theta - fourTheta2);
			  double coeff2 = 3 * s * (5 * theta - fourTheta2);
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final double coeff3 = 3 * s * theta;
			  double coeff3 = 3 * s * theta;
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
...
//ORIGINAL LINE: final double yDot4 = yDotK[3][i];
		  ...
		  {
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final double s = oneMinusThetaH / 8.0;
			  double s = oneMinusThetaH / 8.0;
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final double fourTheta2 = 4 * theta * theta;
			  double fourTheta2 = 4 * theta * theta;
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final double coeff1 = s * (1 - 7 * theta + 2 * fourTheta2);
			  double coeff1 = s * (1 - 7 * theta + 2 * fourTheta2);
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final double coeff2 = 3 * s * (1 + theta - fourTheta2);
			  double coeff2 = 3 * s * (1 + theta - fourTheta2);
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final double coeff3 = 3 * s * (1 + theta);
